...
macro_rules! define_assert_deref {
    ($dest:ident, $op1:ident) => {
        paste! {
            /// Function without incrementing `ap`: `assert_[ap/fp]_deref_[ap/fp]`.
            ...
            /// Function with incrementing `ap`: `assert_[ap/fp]_deref_[ap/fp]_appp`.
...
macro_rules! define_assert_double_deref {
    ($dest:ident, $op1:ident) => {
        paste! {
            /// Function without incrementing `ap`: `assert_[ap/fp]_double_deref_[ap/fp]`.
            ...
            /// Function with incrementing `ap`: `assert_[ap/fp]_double_deref_[ap/fp]_appp`.
