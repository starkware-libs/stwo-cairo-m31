...
use crate::memory::{MaybeRelocatableAddr, Memory, MAX_MEMORY_SIZE_BITS};
use crate::utils::{
...
// TODO: fix to 1 << MAX_MEMORY_SIZE_BITS, need to separate this segment so that memory won't get
// too big.
const IMMEDIATES_SEGMENT: Segment = MAX_MEMORY_SIZE_BITS as usize;
...
impl VM {
    ...
    pub fn create_for_main_entry_point(program: Program, input: Input) -> Self {
        ...
        // Segment MAX_MEMORY_SIZE_BITS - 1: immediates.
