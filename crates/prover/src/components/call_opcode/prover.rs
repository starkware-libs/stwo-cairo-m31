...
use super::component::{Claim, InteractionClaim, CALL_INSTRUCTION};
use crate::components::call_opcode::component::CALL_N_TRACE_CELLS;
...
fn write_trace_simd(
    ...
    let n_trace_columns = CALL_N_TRACE_CELLS;
...
fn write_trace_row(
    ...
    lookup_data.memory_outputs[0].push(PackedM31::broadcast(CALL_INSTRUCTION));
