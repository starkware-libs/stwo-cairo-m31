...
use crate::relations::RangeCheck_15;

pub const N_TRACE_COLUMNS: usize = 1;
pub const LOG_RANGE: u32 = 15;
...
pub struct Eval {
    pub claim: Claim,
    pub range_check_15_lookup_elements: RangeCheck_15,
}
impl Eval {
    pub fn new(claim: Claim, range_check_15_lookup_elements: RangeCheck_15) -> Self {
        Self {
            claim,
            range_check_15_lookup_elements,
        }
    }
}
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        eval.add_to_relation(RelationEntry::new(
            &self.range_check_15_lookup_elements,
